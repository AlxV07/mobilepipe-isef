...
* The rest of the codebase was written by hand (even top closed-source models (tested w/ GPT-5, Gemini 3) struggled significantly when attempting to handle thePython + Swift environment with the more obscure MPSGraph framework.
...
* `workflow` - Experiment Workflow: training scripts and CLI tools for running automated run workflows
